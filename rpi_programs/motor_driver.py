"""
This script is for controlling a motor driver using GPIO pins on a Raspberry Pi.
It subscribes to a topic for commands and publishes the status of the shooting process.
It uses the rclpy library for ROS 2 communication and the RPi.GPIO library for GPIO control.

Some parts of the code below were used in the testing phase and are not used in the final version.
"""
