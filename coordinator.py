...
class CoordinatorNode(Node):
    def __init__(self):
        ...
        self.nav_pub = self.create_publisher(String, 'assisted_drive_command_in', 10)
    ...
    def spin_robot(self):
        ...
        twist_msg = Twist()
        twist_msg.angular.z = 0.5  # Set angular velocity (adjust as needed)
    ...
    def start_navigation(self):
        self.nav_pub.publish(String(data='start_navigation'))
